...
void trace_head();
void get_destination(int** destin);
void vminit();
void getoctal();
void ifetch();
void findopcd();
void exopcode();
void vmtrace();
void get_source_dest(int** source, int** destin);
void fhighreg();
void findlow();
void branch();
void findindex(int* ea, int modetype, int ireg);
...
extern	void	mov(), cmp(), add(), sub(), bic(), bis(), movb(), cmpb(),
